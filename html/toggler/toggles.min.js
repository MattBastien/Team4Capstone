...
*/
(function(g){function p(q){var p=g.Toggles=function(c,a){var g=this;$initVal = document.getElementById(c.context.id).getAttribute('value');if(c.context.id=="device1"){ $on="LOCKED";$off="UNLOCKED";}else{$on="ON";$off="OFF";}if("boolean"===typeof a&&c.data("toggles"))c.data("toggles").toggle(a);else{for(var k="on drag click width height animate easing type checkbox".split(" "),b={},l=0;l<k.length;l++){var t=c.data("toggle-"+k[l]);"undefined"!==typeof t&&(b[k[l]]=t)}a=q.extend({drag:!0,click:!0,text:{on:$on,off:$off},on:eval($initVal),animate:250,easing:"swing",checkbox:null,clicker:null,width:0,height:0,type:"compact",event:"toggle"},a||{},b);c.data("toggles",
